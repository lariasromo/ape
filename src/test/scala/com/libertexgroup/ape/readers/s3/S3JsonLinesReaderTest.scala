...
object S3JsonLinesReaderTest extends ZIOSpec[S3 with S3Config with MinioContainer with S3FileReaderService[S3Config]] {
  val reader = Ape.readers.s3[S3Config].jsonLines[dummy]
