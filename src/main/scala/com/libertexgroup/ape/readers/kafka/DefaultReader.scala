...
protected[kafka] class DefaultReader[Config <: KafkaConfig :Tag]
  extends KafkaReader[Config, Config, ConsumerRecord[String, Array[Byte]]] {

  def createStream(kafkaConfig: KafkaConfig): ZStream[Config, Throwable, ConsumerRecord[String, Array[Byte]]] = {
  ...
  override protected[this] def read: ZIO[Config, Throwable,
      ZStream[Config, Throwable, ConsumerRecord[String, Array[Byte]]]] =
    for {
