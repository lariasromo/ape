...
import com.libertexgroup.ape.transformers.{DefaultTransformer, Transformer}
...
abstract class Reader[E, E1, T: ClassTag] {
  ...
  def -+>[E2, T2: ClassTag](writer: Writer[E1, E2, T2])
                           (implicit transformer: Transformer[E1, T, T2]): Pipeline[E, E1, T, T2, E2] =
    new Pipeline(this, transformer, writer)
}
